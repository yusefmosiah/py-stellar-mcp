...
report = {
    ...
    "test_name": "Basic Integration Tests",
    "results": [],
    "accounts": {},
...
def generate_markdown_report():
    ...
    filename = f"test_reports/basic_report_{timestamp_str}.md"
    ...
    md = []
    md.append("# Basic Integration Test Report")
...
print("=" * 70)
print("STELLAR MCP SERVER - BASIC INTEGRATION TESTS")
print("=" * 70)
print()
